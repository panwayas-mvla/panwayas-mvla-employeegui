...
public class EmpDataGUIPG extends Application {
	...
	/** The controller. */
	private ListControllerPG controller = new ListControllerPG();
	...
	private void callAddEmployee( ) {
		String error = controller.addEmployee(EmployeePG.getNextID(), fName.getText(), lName.getText(), 
